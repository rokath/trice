...
// triceHeader is only for internal usage.
TRICE_INLINE void triceLongHeader( uint32_t header, uint16_t count ){
    TRICE_HTON_U32PUSH( header|triceCycle );
    TRICE_HTON_U32PUSH( TRICE_LONGCOUNT(count) );
    triceCycle++; 
}
