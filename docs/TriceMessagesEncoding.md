...
* 2. [COBS encoding and user protocols](#COBSencodinganduserprotocols)
* 3. [[COBS](https://en.wikipedia.org/wiki/Consistent_Overhead_Byte_Stuffing) encoding for re-sync after data disruption](#COBShttps:en.wikipedia.orgwikiConsistent_Overhead_Byte_Stuffingencodingforre-syncafterdatadisruption)
* 4. [32-bit transfer chunks](#bittransferchunks)
	* 4.1. [Example: zero-delimited 7-bytes COBS package](#Example:zero-delimited7-bytesCOBSpackage)
	* 4.2. [Example: zero-delimited 8-bytes COBS package:](#Example:zero-delimited8-bytesCOBSpackage:)
* 5. [Package mode prefix](#Packagemodeprefix)
	* 5.1. [Example: 12 byte trice message buffer prefixed with mode 0 (no time stamps):](#Example:12bytetricemessagebufferprefixedwithmode0notimestamps:)
	* 5.2. [Example: 16 byte trice message buffer prefixed with mode 1 (time stamps)](#Example:16bytetricemessagebufferprefixedwithmode1timestamps)
	* 5.3. [Example: 12-bytes user packet - will be ignored by the **trice** tool:](#Example:12-bytesuserpacket-willbeignoredbythetricetool:)
...
##  2. <a name='COBSencodinganduserprotocols'></a>COBS encoding and user protocols
...
##  3. <a name='COBShttps:en.wikipedia.orgwikiConsistent_Overhead_Byte_Stuffingencodingforre-syncafterdatadisruption'></a>[COBS](https://en.wikipedia.org/wiki/Consistent_Overhead_Byte_Stuffing) encoding for re-sync after data disruption
...
##  4. <a name='bittransferchunks'></a>32-bit transfer chunks
...
###  4.1. <a name='Example:zero-delimited7-bytesCOBSpackage'></a>Example: zero-delimited 7-bytes COBS package
...
###  4.2. <a name='Example:zero-delimited8-bytesCOBSpackage:'></a>Example: zero-delimited 8-bytes COBS package:
...
##  5. <a name='Packagemodeprefix'></a>Package mode prefix
...
###  5.1. <a name='Example:12bytetricemessagebufferprefixedwithmode0notimestamps:'></a>Example: 12 byte trice message buffer prefixed with mode 0 (no time stamps):
...
###  5.2. <a name='Example:16bytetricemessagebufferprefixedwithmode1timestamps'></a>Example: 16 byte trice message buffer prefixed with mode 1 (time stamps)
...
###  5.3. <a name='Example:12-bytesuserpacket-willbeignoredbythetricetool:'></a>Example: 12-bytes user packet - will be ignored by the **trice** tool:
