...
#define LogConfigInfo() trice8(iD(13009), "dbg:CONFIGURATION == %d - An example configuration with direct RTT output only and optimized for speed\n", CONFIGURATION );
#define TRICE_DIRECT_OUTPUT 1
#define TRICE_BUFFER TRICE_STACK_BUFFER
#define TRICE_PROTECT 0
#define TRICE_DIAGNOSTICS 0
...
#define LogConfigInfo() trice8(iD(13010), "dbg:CONFIGURATION == %d - UART, no cycle counter, no critical sections.\n", CONFIGURATION );
#define TRICE_DEFERRED_OUTPUT 1
#define TRICE_DEFERRED_UARTA 1
#define TRICE_UARTA USART2
#define TRICE_BUFFER TRICE_DOUBLE_BUFFER
...
#define LogConfigInfo() trice8(iD(13011), "dbg:CONFIGURATION == %d - An minimum configuration example.\n", CONFIGURATION );
#define TRICE_DEFERRED_OUTPUT 1
#define TRICE_DEFERRED_UARTA 1
#define TRICE_UARTA USART2
#define TRICE_BUFFER TRICE_RING_BUFFER
...
#define LogConfigInfo() trice8(iD(13012), "dbg:CONFIGURATION == %d - An example configuration with direct RTT output and parallel deferred UART output.\n", CONFIGURATION );
#define TRICE_DEFERRED_OUTPUT 1
#define TRICE_DEFERRED_UARTA 1
#define TRICE_UARTA USART2
#define TRICE_BUFFER TRICE_RING_BUFFER
