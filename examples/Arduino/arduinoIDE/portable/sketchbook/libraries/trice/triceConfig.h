...
//#include  <SoftwareSerial.h> // hardware specific stuff
...
#define TRICE_FIFO_SIZE 128 //!< must be a power of 2, one trice needs 4 to 32 bytes, must hold trice bursts until they are transmitted, fifo is transmitted with lower priority
...
#define TRICE_STRINGS NONE_RUNTIME //! options: NONE_RUNTIME, RARE_RUNTIME, FULL_RUNTIME
...
#define RUNTIME_STRING_FIFO_SIZE 80
#endif
...
#define TRICE_PRINTF_ADAPTER 0 // options: 0, 1
...
//#define TRICE_QUICK_AND_DIRTY_ONLY_PUTCHAR // for a quick start you can enable this line and rely only on putchar
...
#elif defined( TRICE_QUICK_AND_DIRTY_ONLY_PUTCHAR )
