...
// Windows: trice log -p jlink -args "-Device STM32G0B1RE" -pf none -prefix off -hs off -d16 -ts16 us -ts32 ms -showID "deb:%5d" -i ../../demoTIL.json -li ../../demoLI.json
...
//      Terminal 2: touch ./temp/trice.bin && trice log -p FILE -args ./temp/trice.bin -pf none -prefix off -hs off -d16 -ts16 us -ts32 ms -i ../../demoTIL.json -li ../../demoLI.json
#define TRICE_DIRECT_OUTPUT 1
#define TRICE_DIRECT_SEGGER_RTT_32BIT_WRITE 1
#define TRICE_BUFFER_SIZE_UP 2048 // "TRICE_DIRECT_BUFFER_SIZE"

// Windows: trice log -p com3         -prefix off -hs off -pw MySecret -pf COBS -ts16 us -ts32 ms -i ../../demoTIL.json -li ../../demoLI.json
// Unix:    trice log -p /dev/ttyACM0 -prefix off -hs off -pw MySecret -pf COBS -ts16 us -ts32 ms -i ../../demoTIL.json -li ../../demoLI.json
