...
// The stream buffer is intentionally larger than one typical poll burst so the
// receiver can keep several framed records until the next scan pass.
#define NODE_STREAM_MAX 1024u
#define NODE_FRAME_MAX 1024u
