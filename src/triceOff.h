...
#define TriceNonBlockingDirectWrite32Auxiliary(enc, count) TRICE_UNUSED(enc) TRICE_UNUSED(count)
#define TriceNonBlockingDeferredWrite32Auxiliary(enc, count) TRICE_UNUSED(enc) TRICE_UNUSED(count)
#define TriceInit()
...
// Allows assert functions to be used with or without idN
...
// Trice ABC macros stay compilable in TRICE_OFF/TRICE_CLEAN builds without
// providing active command transmit support.
#define TRIce_C(...)
#define TRICe_C(...)
#define TRICE_C(...)
#define TRIce8_C(...)
