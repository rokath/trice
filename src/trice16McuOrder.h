...
#define trice16m_7(tid, v0, v1, v2, v3, v4, v5, v6)                   \
	TRICE_ENTER                                                       \
	TRICE_PUT((14l << 24) | (((uint_fast32_t)(TRICE_CYCLE)) << 16) | (0x4000 | (tid))); \
...
#define Trice16m_0(tid)                            \
	...
	TRICE_PUT(0l << 24 | (((uint_fast32_t)(TRICE_CYCLE)) << 16) | ts); \
	TRICE_LEAVE
...
#define Trice16m_1(tid, v0)                        \
	...
	uint16_t ts = TriceStamp16;                    \
	TRICE_PUT(0x80008000 | (((uint_fast32_t)(tid)) << 16) | (tid)); \
	TRICE_PUT(2l << 24 | (((uint_fast32_t)(TRICE_CYCLE)) << 16) | ts); \
	TRICE_PUT16_1(v0)                              \
	TRICE_LEAVE
...
#define Trice16m_2(tid, v0, v1)                    \
	...
	uint16_t ts = TriceStamp16;                    \
	TRICE_PUT(0x80008000 | (((uint_fast32_t)(tid)) << 16) | (tid)); \
	TRICE_PUT(4l << 24 | (((uint_fast32_t)(TRICE_CYCLE)) << 16) | ts); \
	TRICE_PUT16_2(v0, v1);                         \
	TRICE_LEAVE
...
#define Trice16m_3(tid, v0, v1, v2)                \
	...
	uint16_t ts = TriceStamp16;                    \
	TRICE_PUT(0x80008000 | (((uint_fast32_t)(tid)) << 16) | (tid)); \
	TRICE_PUT(6l << 24 | (((uint_fast32_t)(TRICE_CYCLE)) << 16) | ts); \
	TRICE_PUT16_3(v0, v1, v2);                     \
	TRICE_LEAVE
...
#define Trice16m_5(tid, v0, v1, v2, v3, v4)         \
	...
	uint16_t ts = TriceStamp16;                     \
	TRICE_PUT(0x80008000 | (((uint_fast32_t)(tid)) << 16) | (tid));  \
	TRICE_PUT(10l << 24 | (((uint_fast32_t)(TRICE_CYCLE)) << 16) | ts); \
	TRICE_PUT16_5(v0, v1, v2, v3, v4);              \
	TRICE_LEAVE
...
#define Trice16m_6(tid, v0, v1, v2, v3, v4, v5)     \
	...
	uint16_t ts = TriceStamp16;                     \
	TRICE_PUT(0x80008000 | (((uint_fast32_t)(tid)) << 16) | (tid));  \
	TRICE_PUT(12l << 24 | (((uint_fast32_t)(TRICE_CYCLE)) << 16) | ts); \
	TRICE_PUT16_6(v0, v1, v2, v3, v4, v5);          \
	TRICE_LEAVE
...
#define Trice16m_7(tid, v0, v1, v2, v3, v4, v5, v6) \
	...
	uint16_t ts = TriceStamp16;                     \
	TRICE_PUT(0x80008000 | (((uint_fast32_t)(tid)) << 16) | (tid));  \
	TRICE_PUT(14l << 24 | (((uint_fast32_t)(TRICE_CYCLE)) << 16) | ts); \
	TRICE_PUT16_7(v0, v1, v2, v3, v4, v5, v6);      \
	TRICE_LEAVE
...
#define Trice16m_9(tid, v0, v1, v2, v3, v4, v5, v6, v7, v8) \
	...
	uint16_t ts = TriceStamp16;                             \
	TRICE_PUT(0x80008000 | (((uint_fast32_t)(tid)) << 16) | (tid));          \
	TRICE_PUT(18l << 24 | (((uint_fast32_t)(TRICE_CYCLE)) << 16) | ts);         \
	TRICE_PUT16_9(v0, v1, v2, v3, v4, v5, v6, v7, v8);      \
	TRICE_LEAVE
...
#define Trice16m_10(tid, v0, v1, v2, v3, v4, v5, v6, v7, v8, v9) \
	...
	uint16_t ts = TriceStamp16;                                  \
	TRICE_PUT(0x80008000 | (((uint_fast32_t)(tid)) << 16) | (tid));               \
	TRICE_PUT(20l << 24 | (((uint_fast32_t)(TRICE_CYCLE)) << 16) | ts);              \
	TRICE_PUT16_10(v0, v1, v2, v3, v4, v5, v6, v7, v8, v9);      \
	TRICE_LEAVE
...
#define Trice16m_11(tid, v0, v1, v2, v3, v4, v5, v6, v7, v8, v9, v10) \
	...
	uint16_t ts = TriceStamp16;                                       \
	TRICE_PUT(0x80008000 | (((uint_fast32_t)(tid)) << 16) | (tid));                    \
	TRICE_PUT(22l << 24 | (((uint_fast32_t)(TRICE_CYCLE)) << 16) | ts);                   \
	TRICE_PUT16_11(v0, v1, v2, v3, v4, v5, v6, v7, v8, v9, v10);      \
	TRICE_LEAVE
...
#define TRice16m_1(tid, v0)                                \
	...
	uint32_t ts = TriceStamp32;                            \
	TRICE_PUT((ts << 16) | 0xc000 | (tid));                \
	TRICE_PUT(2l << 24 | (((uint_fast32_t)(TRICE_CYCLE)) << 16) | (ts >> 16)); \
	TRICE_PUT16_1(v0)                                      \
	TRICE_LEAVE
...
#define TRice16m_2(tid, v0, v1)                            \
	...
	uint32_t ts = TriceStamp32;                            \
	TRICE_PUT((ts << 16) | 0xc000 | (tid));                \
	TRICE_PUT(4l << 24 | (((uint_fast32_t)(TRICE_CYCLE)) << 16) | (ts >> 16)); \
	TRICE_PUT16_2(v0, v1);                                 \
	TRICE_LEAVE
...
#define TRice16m_3(tid, v0, v1, v2)                        \
	...
	uint32_t ts = TriceStamp32;                            \
	TRICE_PUT((ts << 16) | 0xc000 | (tid));                \
	TRICE_PUT(6l << 24 | (((uint_fast32_t)(TRICE_CYCLE)) << 16) | (ts >> 16)); \
	TRICE_PUT16_3(v0, v1, v2);                             \
	TRICE_LEAVE
...
#define TRice16m_5(tid, v0, v1, v2, v3, v4)                 \
	...
	uint32_t ts = TriceStamp32;                             \
	TRICE_PUT((ts << 16) | 0xc000 | (tid));                 \
	TRICE_PUT(10l << 24 | (((uint_fast32_t)(TRICE_CYCLE)) << 16) | (ts >> 16)); \
	TRICE_PUT16_5(v0, v1, v2, v3, v4);                      \
	TRICE_LEAVE
...
#define TRice16m_6(tid, v0, v1, v2, v3, v4, v5)             \
	...
	uint32_t ts = TriceStamp32;                             \
	TRICE_PUT((ts << 16) | 0xc000 | (tid));                 \
	TRICE_PUT(12l << 24 | (((uint_fast32_t)(TRICE_CYCLE)) << 16) | (ts >> 16)); \
	TRICE_PUT16_6(v0, v1, v2, v3, v4, v5);                  \
	TRICE_LEAVE
...
#define TRice16m_7(tid, v0, v1, v2, v3, v4, v5, v6)         \
	...
	uint32_t ts = TriceStamp32;                             \
	TRICE_PUT((ts << 16) | 0xc000 | (tid));                 \
	TRICE_PUT(14l << 24 | (((uint_fast32_t)(TRICE_CYCLE)) << 16) | (ts >> 16)); \
	TRICE_PUT16_7(v0, v1, v2, v3, v4, v5, v6);              \
	TRICE_LEAVE
...
#define TRice16m_9(tid, v0, v1, v2, v3, v4, v5, v6, v7, v8) \
	...
	uint32_t ts = TriceStamp32;                             \
	TRICE_PUT((ts << 16) | 0xc000 | (tid));                 \
	TRICE_PUT(18l << 24 | (((uint_fast32_t)(TRICE_CYCLE)) << 16) | (ts >> 16)); \
	TRICE_PUT16_9(v0, v1, v2, v3, v4, v5, v6, v7, v8);      \
	TRICE_LEAVE
...
#define TRice16m_10(tid, v0, v1, v2, v3, v4, v5, v6, v7, v8, v9) \
	...
	uint32_t ts = TriceStamp32;                                  \
	TRICE_PUT((ts << 16) | 0xc000 | (tid));                      \
	TRICE_PUT(20l << 24 | (((uint_fast32_t)(TRICE_CYCLE)) << 16) | (ts >> 16));      \
	TRICE_PUT16_10(v0, v1, v2, v3, v4, v5, v6, v7, v8, v9);      \
	TRICE_LEAVE
...
#define TRice16m_11(tid, v0, v1, v2, v3, v4, v5, v6, v7, v8, v9, v10) \
	...
	uint32_t ts = TriceStamp32;                                       \
	TRICE_PUT((ts << 16) | 0xc000 | (tid));                           \
	TRICE_PUT(22l << 24 | (((uint_fast32_t)(TRICE_CYCLE)) << 16) | (ts >> 16));           \
	TRICE_PUT16_11(v0, v1, v2, v3, v4, v5, v6, v7, v8, v9, v10);      \
	TRICE_LEAVE
