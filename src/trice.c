...
#error configuration: TRICE_UARTA_MIN_ID and TRICE_UARTA_MAX_ID must both be 0 or both be set
#elif (TRICE_UARTA_MIN_ID < 0) || (TRICE_UARTA_MAX_ID > 16383) || (TRICE_UARTA_MIN_ID > TRICE_UARTA_MAX_ID)
#error configuration: TRICE_UARTA_MIN_ID and TRICE_UARTA_MAX_ID must satisfy 1 <= MIN_ID <= MAX_ID <= 16383, or both be 0
#endif
#endif

#if TRICE_DEFERRED_UARTB == 1
#if ((TRICE_UARTB_MIN_ID == 0) != (TRICE_UARTB_MAX_ID == 0))
#error configuration: TRICE_UARTB_MIN_ID and TRICE_UARTB_MAX_ID must both be 0 or both be set
#elif (TRICE_UARTB_MIN_ID < 0) || (TRICE_UARTB_MAX_ID > 16383) || (TRICE_UARTB_MIN_ID > TRICE_UARTB_MAX_ID)
#error configuration: TRICE_UARTB_MIN_ID and TRICE_UARTB_MAX_ID must satisfy 1 <= MIN_ID <= MAX_ID <= 16383, or both be 0
#endif
#endif

#if TRICE_DEFERRED_AUXILIARY8 == 1
#if ((TRICE_DEFERRED_AUXILIARY8_MIN_ID == 0) != (TRICE_DEFERRED_AUXILIARY8_MAX_ID == 0))
#error configuration: TRICE_DEFERRED_AUXILIARY8_MIN_ID and TRICE_DEFERRED_AUXILIARY8_MAX_ID must both be 0 or both be set
#elif (TRICE_DEFERRED_AUXILIARY8_MIN_ID < 0) || (TRICE_DEFERRED_AUXILIARY8_MAX_ID > 16383) || (TRICE_DEFERRED_AUXILIARY8_MIN_ID > TRICE_DEFERRED_AUXILIARY8_MAX_ID)
#error configuration: TRICE_DEFERRED_AUXILIARY8_MIN_ID and TRICE_DEFERRED_AUXILIARY8_MAX_ID must satisfy 1 <= MIN_ID <= MAX_ID <= 16383, or both be 0
#endif
#endif

#if TRICE_DEFERRED_AUXILIARY32 == 1
#if ((TRICE_DEFERRED_AUXILIARY32_MIN_ID == 0) != (TRICE_DEFERRED_AUXILIARY32_MAX_ID == 0))
#error configuration: TRICE_DEFERRED_AUXILIARY32_MIN_ID and TRICE_DEFERRED_AUXILIARY32_MAX_ID must both be 0 or both be set
#elif (TRICE_DEFERRED_AUXILIARY32_MIN_ID < 0) || (TRICE_DEFERRED_AUXILIARY32_MAX_ID > 16383) || (TRICE_DEFERRED_AUXILIARY32_MIN_ID > TRICE_DEFERRED_AUXILIARY32_MAX_ID)
#error configuration: TRICE_DEFERRED_AUXILIARY32_MIN_ID and TRICE_DEFERRED_AUXILIARY32_MAX_ID must satisfy 1 <= MIN_ID <= MAX_ID <= 16383, or both be 0
#endif
#endif

#if TRICE_DEFERRED_SEGGER_RTT_8BIT_WRITE == 1
#if ((TRICE_DEFERRED_SEGGER_RTT_8BIT_WRITE_MIN_ID == 0) != (TRICE_DEFERRED_SEGGER_RTT_8BIT_WRITE_MAX_ID == 0))
#error configuration: TRICE_DEFERRED_SEGGER_RTT_8BIT_WRITE_MIN_ID and TRICE_DEFERRED_SEGGER_RTT_8BIT_WRITE_MAX_ID must both be 0 or both be set
#elif (TRICE_DEFERRED_SEGGER_RTT_8BIT_WRITE_MIN_ID < 0) || (TRICE_DEFERRED_SEGGER_RTT_8BIT_WRITE_MAX_ID > 16383) || (TRICE_DEFERRED_SEGGER_RTT_8BIT_WRITE_MIN_ID > TRICE_DEFERRED_SEGGER_RTT_8BIT_WRITE_MAX_ID)
#error configuration: TRICE_DEFERRED_SEGGER_RTT_8BIT_WRITE_MIN_ID and TRICE_DEFERRED_SEGGER_RTT_8BIT_WRITE_MAX_ID must satisfy 1 <= MIN_ID <= MAX_ID <= 16383, or both be 0
#endif
#endif
