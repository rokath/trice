...
#define Trice8m_0(tid)                                       \
	...
	TRICE_PUT(0l << 24 | ((TRICE_CYCLE) << 16) | ts_Trice8m_0); \
	TRICE_LEAVE
...
#define Trice8m_1(tid, v0)                                   \
	...
	TRICE_PUT(0x80008000 | (((uint_fast32_t)(tid)) << 16) | (tid));             \
	TRICE_PUT(1l << 24 | ((TRICE_CYCLE) << 16) | ts_Trice8m_1); \
	TRICE_PUT8_1(v0)                                         \
	TRICE_LEAVE
...
#define Trice8m_2(tid, v0, v1)                               \
	...
	TRICE_PUT(0x80008000 | (((uint_fast32_t)(tid)) << 16) | (tid));             \
	TRICE_PUT(2l << 24 | ((TRICE_CYCLE) << 16) | ts_Trice8m_2); \
	TRICE_PUT8_2(v0, v1);                                    \
	TRICE_LEAVE
...
#define Trice8m_3(tid, v0, v1, v2)                           \
	...
	TRICE_PUT(0x80008000 | (((uint_fast32_t)(tid)) << 16) | (tid));             \
	TRICE_PUT(3l << 24 | ((TRICE_CYCLE) << 16) | ts_Trice8m_3); \
	TRICE_PUT8_3(v0, v1, v2);                                \
	TRICE_LEAVE
...
#define Trice8m_4(tid, v0, v1, v2, v3)                       \
	...
	TRICE_PUT(0x80008000 | (((uint_fast32_t)(tid)) << 16) | (tid));             \
	TRICE_PUT(4l << 24 | ((TRICE_CYCLE) << 16) | ts_Trice8m_4); \
	TRICE_PUT8_4(v0, v1, v2, v3);                            \
	TRICE_LEAVE
...
#define Trice8m_5(tid, v0, v1, v2, v3, v4)                   \
	...
	TRICE_PUT(0x80008000 | (((uint_fast32_t)(tid)) << 16) | (tid));             \
	TRICE_PUT(5l << 24 | ((TRICE_CYCLE) << 16) | ts_Trice8m_5); \
	TRICE_PUT8_5(v0, v1, v2, v3, v4);                        \
	TRICE_LEAVE
...
#define Trice8m_6(tid, v0, v1, v2, v3, v4, v5)               \
	...
	TRICE_PUT(0x80008000 | (((uint_fast32_t)(tid)) << 16) | (tid));             \
	TRICE_PUT(6l << 24 | ((TRICE_CYCLE) << 16) | ts_Trice8m_6); \
	TRICE_PUT8_6(v0, v1, v2, v3, v4, v5);                    \
	TRICE_LEAVE
...
#define Trice8m_7(tid, v0, v1, v2, v3, v4, v5, v6)           \
	...
	TRICE_PUT(0x80008000 | (((uint_fast32_t)(tid)) << 16) | (tid));             \
	TRICE_PUT(7l << 24 | ((TRICE_CYCLE) << 16) | ts_Trice8m_7); \
	TRICE_PUT8_7(v0, v1, v2, v3, v4, v5, v6);                \
	TRICE_LEAVE
...
#define Trice8m_8(tid, v0, v1, v2, v3, v4, v5, v6, v7)       \
	...
	TRICE_PUT(0x80008000 | (((uint_fast32_t)(tid)) << 16) | (tid));             \
	TRICE_PUT(8l << 24 | ((TRICE_CYCLE) << 16) | ts_Trice8m_8); \
	TRICE_PUT8_8(v0, v1, v2, v3, v4, v5, v6, v7);            \
	TRICE_LEAVE
...
#define Trice8m_9(tid, v0, v1, v2, v3, v4, v5, v6, v7, v8)   \
	...
	TRICE_PUT(0x80008000 | (((uint_fast32_t)(tid)) << 16) | (tid));             \
	TRICE_PUT(9l << 24 | ((TRICE_CYCLE) << 16) | ts_Trice8m_9); \
	TRICE_PUT8_9(v0, v1, v2, v3, v4, v5, v6, v7, v8);        \
	TRICE_LEAVE
...
#define Trice8m_10(tid, v0, v1, v2, v3, v4, v5, v6, v7, v8, v9) \
	...
	TRICE_PUT(0x80008000 | (((uint_fast32_t)(tid)) << 16) | (tid));                \
	TRICE_PUT(10l << 24 | ((TRICE_CYCLE) << 16) | ts_Trice8m_10);  \
	TRICE_PUT8_10(v0, v1, v2, v3, v4, v5, v6, v7, v8, v9);      \
	TRICE_LEAVE
...
#define Trice8m_11(tid, v0, v1, v2, v3, v4, v5, v6, v7, v8, v9, v10) \
	...
	TRICE_PUT(0x80008000 | (((uint_fast32_t)(tid)) << 16) | (tid));                     \
	TRICE_PUT(11l << 24 | ((TRICE_CYCLE) << 16) | ts_Trice8m_11);       \
	TRICE_PUT8_11(v0, v1, v2, v3, v4, v5, v6, v7, v8, v9, v10);      \
	TRICE_LEAVE
...
#define Trice8m_12(tid, v0, v1, v2, v3, v4, v5, v6, v7, v8, v9, v10, v11) \
	...
	TRICE_PUT(0x80008000 | (((uint_fast32_t)(tid)) << 16) | (tid));                          \
	TRICE_PUT(12l << 24 | ((TRICE_CYCLE) << 16) | ts_Trice8m_12);            \
	TRICE_PUT8_12(v0, v1, v2, v3, v4, v5, v6, v7, v8, v9, v10, v11)       \
	TRICE_LEAVE
...
#define TRice8m_0(tid)                                               \
	...
	TRICE_PUT(0l << 24 | ((TRICE_CYCLE) << 16) | (ts_TRice8m_0 >> 16)); \
	TRICE_LEAVE
...
#define TRice8m_1(tid, v0)                                           \
	...
	TRICE_PUT(1l << 24 | ((TRICE_CYCLE) << 16) | (ts_TRice8m_1 >> 16)); \
	TRICE_PUT8_1(v0)                                                 \
	TRICE_LEAVE
...
#define TRice8m_2(tid, v0, v1)                                       \
	...
	TRICE_PUT(2l << 24 | ((TRICE_CYCLE) << 16) | (ts_TRice8m_2 >> 16)); \
	TRICE_PUT8_2(v0, v1);                                            \
	TRICE_LEAVE
...
#define TRice8m_3(tid, v0, v1, v2)                                   \
	...
	TRICE_PUT(3l << 24 | ((TRICE_CYCLE) << 16) | (ts_TRice8m_3 >> 16)); \
	TRICE_PUT8_3(v0, v1, v2);                                        \
	TRICE_LEAVE
...
#define TRice8m_4(tid, v0, v1, v2, v3)                               \
	...
	TRICE_PUT(4l << 24 | ((TRICE_CYCLE) << 16) | (ts_TRice8m_4 >> 16)); \
	TRICE_PUT8_4(v0, v1, v2, v3);                                    \
	TRICE_LEAVE
...
#define TRice8m_5(tid, v0, v1, v2, v3, v4)                           \
	...
	TRICE_PUT(5l << 24 | ((TRICE_CYCLE) << 16) | (ts_TRice8m_5 >> 16)); \
	TRICE_PUT8_5(v0, v1, v2, v3, v4);                                \
	TRICE_LEAVE
...
#define TRice8m_6(tid, v0, v1, v2, v3, v4, v5)                       \
	...
	TRICE_PUT(6l << 24 | ((TRICE_CYCLE) << 16) | (ts_TRice8m_6 >> 16)); \
	TRICE_PUT8_6(v0, v1, v2, v3, v4, v5);                            \
	TRICE_LEAVE
...
#define TRice8m_7(tid, v0, v1, v2, v3, v4, v5, v6)                   \
	...
	TRICE_PUT(7l << 24 | ((TRICE_CYCLE) << 16) | (ts_TRice8m_7 >> 16)); \
	TRICE_PUT8_7(v0, v1, v2, v3, v4, v5, v6);                        \
	TRICE_LEAVE
...
#define TRice8m_8(tid, v0, v1, v2, v3, v4, v5, v6, v7)               \
	...
	TRICE_PUT(8l << 24 | ((TRICE_CYCLE) << 16) | (ts_TRice8m_8 >> 16)); \
	TRICE_PUT8_8(v0, v1, v2, v3, v4, v5, v6, v7);                    \
	TRICE_LEAVE
...
#define TRice8m_9(tid, v0, v1, v2, v3, v4, v5, v6, v7, v8)           \
	...
	TRICE_PUT(9l << 24 | ((TRICE_CYCLE) << 16) | (ts_TRice8m_9 >> 16)); \
	TRICE_PUT8_9(v0, v1, v2, v3, v4, v5, v6, v7, v8);                \
	TRICE_LEAVE
...
#define TRice8m_10(tid, v0, v1, v2, v3, v4, v5, v6, v7, v8, v9)        \
	...
	TRICE_PUT(10l << 24 | ((TRICE_CYCLE) << 16) | (ts_TRice8m_10 >> 16)); \
	TRICE_PUT8_10(v0, v1, v2, v3, v4, v5, v6, v7, v8, v9);             \
	TRICE_LEAVE
...
#define TRice8m_11(tid, v0, v1, v2, v3, v4, v5, v6, v7, v8, v9, v10)   \
	...
	TRICE_PUT(11l << 24 | ((TRICE_CYCLE) << 16) | (ts_TRice8m_11 >> 16)); \
	TRICE_PUT8_11(v0, v1, v2, v3, v4, v5, v6, v7, v8, v9, v10);        \
	TRICE_LEAVE
...
#define TRice8m_12(tid, v0, v1, v2, v3, v4, v5, v6, v7, v8, v9, v10, v11) \
	...
	TRICE_PUT(12l << 24 | ((TRICE_CYCLE) << 16) | (ts_TRice8m_12 >> 16));    \
	TRICE_PUT8_12(v0, v1, v2, v3, v4, v5, v6, v7, v8, v9, v10, v11)       \
	TRICE_LEAVE
