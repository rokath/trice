...
#define trice32m_7(tid, v0, v1, v2, v3, v4, v5, v6)                   \
	TRICE_ENTER                                                       \
	TRICE_PUT((28l << 24) | (((uint_fast32_t)(TRICE_CYCLE)) << 16) | (0x4000 | (tid))); \
...
#define trice32m_9(tid, v0, v1, v2, v3, v4, v5, v6, v7, v8)           \
	TRICE_ENTER                                                       \
	TRICE_PUT((36l << 24) | (((uint_fast32_t)(TRICE_CYCLE)) << 16) | (0x4000 | (tid))); \
...
#define trice32m_11(tid, v0, v1, v2, v3, v4, v5, v6, v7, v8, v9, v10) \
	TRICE_ENTER                                                       \
	TRICE_PUT((44l << 24) | (((uint_fast32_t)(TRICE_CYCLE)) << 16) | (0x4000 | (tid))); \
...
#define Trice32m_7(tid, v0, v1, v2, v3, v4, v5, v6) \
	...
	uint16_t ts = TriceStamp16;                     \
	TRICE_PUT(0x80008000 | (((uint_fast32_t) tid) << 16) | (tid));    \
	TRICE_PUT(28l << 24 | (((uint_fast32_t)(TRICE_CYCLE)) << 16) | ts); \
	TRICE_PUT32_7(v0, v1, v2, v3, v4, v5, v6);      \
	TRICE_LEAVE
...
#define Trice32m_9(tid, v0, v1, v2, v3, v4, v5, v6, v7, v8) \
	...
	uint16_t ts = TriceStamp16;                             \
	TRICE_PUT(0x80008000 | (((uint_fast32_t) tid) << 16) | (tid));            \
	TRICE_PUT(36l << 24 | (((uint_fast32_t)(TRICE_CYCLE)) << 16) | ts);         \
	TRICE_PUT32_9(v0, v1, v2, v3, v4, v5, v6, v7, v8);      \
	TRICE_LEAVE
...
#define Trice32m_11(tid, v0, v1, v2, v3, v4, v5, v6, v7, v8, v9, v10) \
	...
	uint16_t ts = TriceStamp16;                                       \
	TRICE_PUT(0x80008000 | (((uint_fast32_t) tid) << 16) | (tid));                      \
	TRICE_PUT(44l << 24 | (((uint_fast32_t)(TRICE_CYCLE)) << 16) | ts);                   \
	TRICE_PUT32_11(v0, v1, v2, v3, v4, v5, v6, v7, v8, v9, v10);      \
	TRICE_LEAVE
...
#define TRice32m_7(tid, v0, v1, v2, v3, v4, v5, v6)         \
	...
	uint32_t ts = TriceStamp32;                             \
	TRICE_PUT((ts << 16) | 0xc000 | (tid));                 \
	TRICE_PUT(28l << 24 | (((uint_fast32_t)(TRICE_CYCLE)) << 16) | (ts >> 16)); \
	TRICE_PUT32_7(v0, v1, v2, v3, v4, v5, v6);              \
	TRICE_LEAVE
...
#define TRice32m_9(tid, v0, v1, v2, v3, v4, v5, v6, v7, v8) \
	...
	uint32_t ts = TriceStamp32;                             \
	TRICE_PUT((ts << 16) | 0xc000 | (tid));                 \
	TRICE_PUT(36l << 24 | (((uint_fast32_t)(TRICE_CYCLE)) << 16) | (ts >> 16)); \
	TRICE_PUT32_9(v0, v1, v2, v3, v4, v5, v6, v7, v8);      \
	TRICE_LEAVE
...
#define TRice32m_11(tid, v0, v1, v2, v3, v4, v5, v6, v7, v8, v9, v10) \
	...
	uint32_t ts = TriceStamp32;                                       \
	TRICE_PUT((ts << 16) | 0xc000 | (tid));                           \
	TRICE_PUT(44l << 24 | (((uint_fast32_t)(TRICE_CYCLE)) << 16) | (ts >> 16));           \
	TRICE_PUT32_11(v0, v1, v2, v3, v4, v5, v6, v7, v8, v9, v10);      \
	TRICE_LEAVE
