...
#line 200 "counter_owned.c"
    trice("fourth"); trice("fifth");

#line 250 "unchanged_line_only.c"
    POC_LINE_ONLY_TRICE("collision-a"); POC_LINE_ONLY_TRICE("collision-b");

#line 260 "generated_shadow.c"
    POC_EXPLICIT_ORDINAL_TRICE(0, "shadow-a"); POC_EXPLICIT_ORDINAL_TRICE(1, "shadow-b");
