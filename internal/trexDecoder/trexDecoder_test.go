...
func TestTREX(t *testing.T) {
	tt := decoder.TestTable{ // little endian
		...
		{[]byte{0x81, 0xbe, 0x09, 0x23, 0xc0, 0x02, 0xb8, 0x01, 0xa4, 0x00}, `MSG: 💚 START select = 440`},
		{[]byte{0xa7, 0xb3, 0x1b, 0x23, 0xc1, 0x10, 0x5c, 0x63, 0x80, 0x61, 0x50, 0x05, 0x62, 0x08, 0x41, 0x00}, `MSG:triceFifoDepthMax = 92 of max 128, triceStreamBufferDepthMax = 1360 of max 2048`},
	}
