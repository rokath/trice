...
var (
	...
	syncTrice = []byte{0x89, 0xab, 0xcd, 0xef} // big endian is the network order
)
...
type TriceReceiver struct {
	...
	atomsCh    chan []Trice // The receivetod and unprocessed trice atoms are sent as slices to this channel.
