...
func init() {
	...
	fsScLog.StringVar(&decoder.Encoding, "encoding", "packl", "The trice transmit data format type, options: 'bare|esc|pack|packl|wrap'. Target device coding must match.") // flag
