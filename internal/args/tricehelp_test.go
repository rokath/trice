...
func TestCOBSLog(t *testing.T) {
	args := []string{"trice", "log", "-idList", "C:/repos/trice.rokath/til.json", "-port", "FILEBUFFER", "-args", "C:/Users/T.Hoehenleitner/AppData/Local/Temp/trice-317444282.bin", "-ts", "off"}
	expect := ""
	execHelper(t, args, expect)
}
