#!/usr/bin/env bash
#
# Step 12a: Builds the TRICE_ON GCC Example matrix in the Inserted state.
...
main() {
  ...
  trice_test_run_managed_workflow insert example "$SCRIPT_DIR/_testAll_12_GccExampleBuilds_common.sh" on
}
