...
#
# Usage:
#   ./scripts/_270_format_go_code.sh                 # defaults to FORMAT mode
#   ./scripts/_270_format_go_code.sh check           # explicit CHECK mode
#   ./scripts/_270_format_go_code.sh format          # FORMAT mode (modify files)
#   ./scripts/_270_format_go_code.sh check --verbose
#   ./scripts/_270_format_go_code.sh format --verbose
#
...
echo "To fix them locally, run: ./scripts/_270_format_go_code.sh format"
exit 1
