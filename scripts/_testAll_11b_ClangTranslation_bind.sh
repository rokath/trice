#!/usr/bin/env bash
#
# Step 11b: Checks the same G0B1 Clang translation in the Bound state.
...
main() {
  ...
  trice_test_run_managed_workflow bind example "$SCRIPT_DIR/_testAll_11_ClangTranslation_common.sh"
}
