#!/usr/bin/env bash
#
# Test 570: Checks the same G0B1 Clang translation in the Bound state.
...
main() {
  ...
  trice_test_run_managed_workflow bind example "$SCRIPT_DIR/_180_clang_translation_worker.sh"
}
