...
void TriceCheck(int n) {
    ...
    //  break; case __LINE__: TRICE64( ID( 1931), "rd:TRICE64 int %d, double %f (%%f), %016x, %064b\n",                  -y, aDouble(-y), aDouble(-y), aDouble(-y) ); //exp: time: 842,150_450default: rd:TRICE64 int 518, double -518.054749 (%f), c080307020601050, 1100000010000000001100000111000000100000011000000001000001010000 
        ...
        break; case __LINE__: TRICE8_B( ID( 7990), "  %02x", b8, sizeof(b8)/sizeof(int8_t) );                  //exp: time: 842,150_450default:   00  ff  fe  33  04  05  06  07  08  09  0a  0b  00  ff  fe  33  04  05  06  07  08  09  0a  0b
        ...
        break; case __LINE__: TRICE( ID( 4451), "\n" );
        ...
        break; case __LINE__: TRICE( ID( 4907), "\n" );
...
//  #endif
        ...
        break; case __LINE__: {
                                  s = "AAAAAAAAAAAA";
                                  TRICE32( ID( 5939), "dbg:len=%u:", strlen(s) );
                                  TRICE_S( ID( 1802), "sig:%s\n", s );
                              }
        break; case __LINE__: {
                s = "\
...
";
        ...
        break; case __LINE__: TRICE32( ID( 7697), "dbg:len=%u:", strlen(s) );
...
";
        ...
        break; case __LINE__: TRICE_S( ID( 5229), "sig:%s\n", s );
    ...
    //  break; case __LINE__: trice( iD( 6826),"info:This is a message with one value %d and without stamp.\n" , -2  ); //exp: time:            default: info:This is a message with one value -2 and without stamp.
        ...
        break; case __LINE__: TRICE( ID( 2965), "e:A");
        break; case __LINE__: TRICE( ID( 6197), "w:B");
        break; case __LINE__: TRICE( ID( 5331), "a:c");
        break; case __LINE__: TRICE( ID( 7936), "wr:d");
        break; case __LINE__: TRICE( ID( 4289), "rd:e\n");
        break; case __LINE__: TRICE( ID( 1890), "diag:f");
        ...
        break; case __LINE__: TRICE( ID( 6206), "e:A"); TRICE( ID( 5373), "w:B"); TRICE( ID( 6701), "a:c");
        break; case __LINE__: TRICE( ID( 4901), "wr:d"); TRICE( ID( 7106), "rd:e\n"); TRICE( ID( 7328), "diag:f");
...
#define SCOPY( element ) do{ char* n = #element; int size = sizeof( src->element ); memcpy( p, &(src->element), size ); p += size; TRICE_S( ID( 3649), "rd:sizeof(%8s)", n ); TRICE( ID( 7360), " = %d\n", size);}while(0);

    //! DCOPY is a helper macro for struct deserialization.
#define DCOPY( element ) do{ char* n = #element; int size = sizeof( dst->element ); memcpy( &(dst->element), p, size ); p += size; TRICE_S( ID( 3483), "rd:sizeof(%8s)", n ); TRICE( ID( 3003), " = %d\n", size);}while(0);
...
static void exampleOfManualSerialization( void ){
    ...
    TRICE8_B( Id( 3438), " %02x ", &tx, sizeof(tx) );
    TRICE( Id( 1352), "\n" );

    TRICE ( Id( 1795), "inf: Tryout buffer:" );
    TRICE8_B( Id( 5888), " %02x ", dst, len ); //lint !e670
    TRICE( Id( 3955), "\n" );
