...
//! When set to TRICE_LITTLE_ENDIANNESS the trice tool -enc format specifier is extended by a letter 'L'.
//! Example -enc "pack2L" -> -enc "pack2L".
#define TRICE_TRANSFER_ENDIANNESS TRICE_BIG_ENDIANNESS 
