...
//! - Whithout encoding/framing this value can be 0.
...
//! - TRICE_FRAMING_TCOBS: Recommended for internal transfer and trice tool vizualization.
...
//! - TRICE_FRAMING_TCOBS: Recommended for UART transfer and trice tool vizualization.
