...
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../Core/Src/system_stm32f0xx.c" 2
...
# 49 "../Core/Src/system_stm32f0xx.c" 2
...
void SystemCoreClockUpdate (void)
{
  ...
  tmp = ((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x00001000UL))->CFGR & (0x3UL << (2U));
  ...
  switch (tmp)
  {
    ...
    case (0x00000008U):
      ...
      pllmull = ((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x00001000UL))->CFGR & (0xFUL << (18U));
      pllsource = ((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x00001000UL))->CFGR & (0x1UL << (16U));
      pllmull = ( pllmull >> 18) + 2;
      predivfactor = (((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x00001000UL))->CFGR2 & (0xFUL << (0U))) + 1;

      if (pllsource == (0x00010000U))
      {

        SystemCoreClock = (8000000/predivfactor) * pllmull;
      }
  ...
  tmp = AHBPrescTable[((((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x00001000UL))->CFGR & (0xFUL << (4U))) >> 4)];
