...
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../Drivers/STM32F0xx_HAL_Driver/Src/stm32f0xx_ll_utils.c" 2
# 21 "../Drivers/STM32F0xx_HAL_Driver/Src/stm32f0xx_ll_utils.c"
...
# 22 "../Drivers/STM32F0xx_HAL_Driver/Src/stm32f0xx_ll_utils.c" 2
...
# 23 "../Drivers/STM32F0xx_HAL_Driver/Src/stm32f0xx_ll_utils.c" 2
...
# 24 "../Drivers/STM32F0xx_HAL_Driver/Src/stm32f0xx_ll_utils.c" 2
# 117 "../Drivers/STM32F0xx_HAL_Driver/Src/stm32f0xx_ll_utils.c"
static uint32_t UTILS_GetPLLOutputFrequency(uint32_t PLL_InputFrequency,
                                               LL_UTILS_PLLInitTypeDef *UTILS_PLLInitStruct);
static ErrorStatus UTILS_EnablePLLAndSwitchSystem(uint32_t SYSCLK_Frequency, LL_UTILS_ClkInitTypeDef *UTILS_ClkInitStruct);
static ErrorStatus UTILS_PLL_IsBusy(void);
# 142 "../Drivers/STM32F0xx_HAL_Driver/Src/stm32f0xx_ll_utils.c"
void LL_Init1msTick(uint32_t HCLKFrequency)
{

  LL_InitTick(HCLKFrequency, 1000U);
}
# 158 "../Drivers/STM32F0xx_HAL_Driver/Src/stm32f0xx_ll_utils.c"
void LL_mDelay(uint32_t Delay)
{
  volatile uint32_t tmp = ((SysTick_Type *) ((0xE000E000UL) + 0x0010UL) )->CTRL;
  ...
  while (Delay)
  {
    if ((((SysTick_Type *) ((0xE000E000UL) + 0x0010UL) )->CTRL & (1UL << 16U)) != 0U)
    {
      Delay--;
    }
  }
}
# 214 "../Drivers/STM32F0xx_HAL_Driver/Src/stm32f0xx_ll_utils.c"
void LL_SetSystemCoreClock(uint32_t HCLKFrequency)
{

  SystemCoreClock = HCLKFrequency;
}
# 229 "../Drivers/STM32F0xx_HAL_Driver/Src/stm32f0xx_ll_utils.c"
ErrorStatus LL_SetFlashLatency(uint32_t Frequency)
{
  uint32_t timeout;
  uint32_t getlatency;
...
# 299 "../Drivers/STM32F0xx_HAL_Driver/Src/stm32f0xx_ll_utils.c"
ErrorStatus LL_PLL_ConfigSystemClock_HSI(LL_UTILS_PLLInitTypeDef *UTILS_PLLInitStruct,
                                         LL_UTILS_ClkInitTypeDef *UTILS_ClkInitStruct)
{
  ErrorStatus status = SUCCESS;
  ...
  if (UTILS_PLL_IsBusy() == SUCCESS)
  {
    ...
    UTILS_PLLInitStruct->Prediv = (0x00000001U);


    pllfreq = UTILS_GetPLLOutputFrequency(8000000, UTILS_PLLInitStruct);
    ...
    LL_RCC_PLL_ConfigDomain_SYS((0x00000000U), UTILS_PLLInitStruct->PLLMul);
...
# 424 "../Drivers/STM32F0xx_HAL_Driver/Src/stm32f0xx_ll_utils.c"
ErrorStatus LL_PLL_ConfigSystemClock_HSE(uint32_t HSEFrequency, uint32_t HSEBypass,
                                         LL_UTILS_PLLInitTypeDef *UTILS_PLLInitStruct, LL_UTILS_ClkInitTypeDef *UTILS_ClkInitStruct)
{
  ErrorStatus status = SUCCESS;
  ...
  if (UTILS_PLL_IsBusy() == SUCCESS)
  {
    ...
    LL_RCC_PLL_ConfigDomain_SYS(((0x00010000U) | UTILS_PLLInitStruct->Prediv), UTILS_PLLInitStruct->PLLMul);
...
# 505 "../Drivers/STM32F0xx_HAL_Driver/Src/stm32f0xx_ll_utils.c"
static uint32_t UTILS_GetPLLOutputFrequency(uint32_t PLL_InputFrequency, LL_UTILS_PLLInitTypeDef *UTILS_PLLInitStruct)
{
  ...
  pllfreq = ((PLL_InputFrequency / (UTILS_PLLInitStruct->Prediv + 1U)) * ((((UTILS_PLLInitStruct->PLLMul) & (0xFUL << (18U))) >> (uint32_t)18U) + 2U));
...
# 554 "../Drivers/STM32F0xx_HAL_Driver/Src/stm32f0xx_ll_utils.c"
static ErrorStatus UTILS_EnablePLLAndSwitchSystem(uint32_t SYSCLK_Frequency, LL_UTILS_ClkInitTypeDef *UTILS_ClkInitStruct)
{
  ErrorStatus status = SUCCESS;
  ...
  sysclk_frequency_current = (SystemCoreClock << AHBPrescTable[LL_RCC_GetAHBPrescaler() >> (uint32_t)4U]);
  ...
  if (status == SUCCESS)
  {
    LL_SetSystemCoreClock(((SYSCLK_Frequency) >> AHBPrescTable[((UTILS_ClkInitStruct->AHBCLKDivider) & (0xFUL << (4U))) >> (4U)]));
  }
