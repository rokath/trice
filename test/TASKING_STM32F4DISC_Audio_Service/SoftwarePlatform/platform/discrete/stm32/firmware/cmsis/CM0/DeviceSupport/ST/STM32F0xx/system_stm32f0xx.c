...
#if STM32F0XX_CMSIS_CLKSRC == STM32F0XX_CMSIS_CLKSRC_HSI
#endif
#if STM32F0XX_CMSIS_CLKSRC == STM32F0XX_CMSIS_CLKSRC_HSE
#  define SYSCLOCK_SETUP_HSE
#  define SYSCLOCK_CLKSRC  RCC_CFGR_SW_HSE
#endif
#if STM32F0XX_CMSIS_CLKSRC == STM32F0XX_CMSIS_CLKSRC_PLLCLKBYHSI
#  define SYSCLOCK_SETUP_PLL
#  define SYSCLOCK_PLL_INPUT  RCC_CFGR_PLLSRC_HSI_PREDIV
#  define SYSCLOCK_CLKSRC  RCC_CFGR_SW_PLL
#endif
#if STM32F0XX_CMSIS_CLKSRC == STM32F0XX_CMSIS_CLKSRC_PLLCLKBYHSE
#  define SYSCLOCK_SETUP_HSE
#  define SYSCLOCK_SETUP_PLL
#  define SYSCLOCK_PLL_INPUT  RCC_CFGR_PLLSRC_HSE_PREDIV
#  define SYSCLOCK_CLKSRC  RCC_CFGR_SW_PLL
#endif
#if STM32F0XX_CMSIS_CLKSRC == STM32F0XX_CMSIS_CLKSRC_HSI48
#  define SYSCLOCK_CLKSRC  RCC_CFGR_SW_HSI48
#endif
#if STM32F0XX_CMSIS_CLKSRC == STM32F0XX_CMSIS_CLKSRC_PLLCLKBYHSI48
#  define SYSCLOCK_SETUP_PLL
#  define SYSCLOCK_PLL_INPUT  RCC_CFGR_PLLSRC_HSI48_PREDIV
#  define SYSCLOCK_CLKSRC  RCC_CFGR_SW_PLL
#endif

#if STM32F0XX_CMSIS_CLOCKHZ <= 24000000
...
/** @addtogroup STM32F0xx_System_Private_Variables
  * @{
  */
uint32_t SystemCoreClock    = STM32F0XX_CMSIS_CLOCKHZ;
...
#ifdef STM32F0XX_CMSIS_MCOPRE
  RCC->CFGR |= STM32F0XX_CMSIS_MCOPRE << 28;
#endif
  RCC->CFGR |= STM32F0XX_CMSIS_MCOSRC << 24;

  /* At this stage the HSI is enabled and used as System clock source */

#ifdef SYSCLOCK_SETUP_HSE
// use pincfg document setting or backup from core plugin
# if defined(PINCFG_RCC_OSC_HSE_EXTERNAL_CLOCK_SOURCE) || (defined(STM32F0XX_CMSIS_HSE_BYPASS) && STM32F0XX_CMSIS_HSE_BYPASS)
...
# endif
  ...
  {
    /* HCLK */
    RCC->CFGR |= (STM32F0XX_CMSIS_AHB << 4);
 
    /* PCLK1 */
    RCC->CFGR |= (STM32F0XX_CMSIS_APB1 << 8);
      
#ifdef SYSCLOCK_SETUP_PLL
    /* PLL configuration */
    RCC->CFGR |= (SYSCLOCK_PLL_INPUT | ((STM32F0XX_CMSIS_PLL_MUL - 2) << 18));
# ifdef STM32F0XX_CMSIS_PLL_PREDIV
    RCC->CFGR2 |= (STM32F0XX_CMSIS_PLL_PREDIV - 1);
# endif
