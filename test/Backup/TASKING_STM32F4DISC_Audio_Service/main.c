...
void main( void )
{
    ...
    if ( audio == NULL )
    {
        TRICE0( Id(41026), "Failed to initialize audio service" );
        abort();
    }
    TRICE0( Id(14382), "Successfully initialized audio service\n" );

    info = wav_parseheader( (uintptr_t) _lc_ub_sound_wav, (uintptr_t) _lc_ue_sound_wav );
    if (wav_testsupported( info ))
    {
    	TRICE0( Id(26286), "Play 'sound.wav'\n-> " );
    	...
    	*/
        ...
        TRICE0( Id(27624), "att:TASKING_STM32F4DISC_Audio_Service_RTTD\n" );
        TRICE16_1( Id(14522), "tim:timing      message, SysTick is %6d\n", SYSTICKVAL16 );
        TRICE16_1( Id(14522), "tim:timing      message, SysTick is %6d\n", SYSTICKVAL16 );
        TRICE16_1( Id(14522), "tim:timing      message, SysTick is %6d\n", SYSTICKVAL16 );
        TRICE16_1( Id(14522), "tim:timing      message, SysTick is %6d\n", SYSTICKVAL16 );
    ...
    {
    	TRICE0( Id(11804), "Invalid wav file\n" );
    }
}
