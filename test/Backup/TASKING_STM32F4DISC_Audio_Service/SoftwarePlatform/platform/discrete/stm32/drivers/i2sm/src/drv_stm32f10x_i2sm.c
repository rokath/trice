...
#include <per_stm32f10x_i2s_cfg_instance.h>
...
__INTERRUPT_NATIVE void stm32f10x_i2sm_handler_native( void )
{
    ...
    switch( num )
    {
    case DMA1_Channel4_IRQn: // DMA I2S2 RX
        DMA_ClearFlag( DMA1_FLAG_TC4 );
        break;
    case DMA1_Channel5_IRQn :   // DMA I2S2 TX
        DMA_ClearFlag( DMA1_FLAG_TC5 );
        break;
    case DMA2_Channel1_IRQn :   // DMA I2S3 RX
        DMA_ClearFlag( DMA2_FLAG_TC1 );
        break;
    case DMA2_Channel2_IRQn :   // DMA I2S3 TX
...
i2sm_t * i2sm_open( unsigned int id )
{
    ...
    const per_stm32f10x_i2s_cfg_instance_t * restrict per_cfg;
    ...
    per_cfg = &per_stm32f10x_i2s_instance_table[drv_cfg->per_stm32_i2s];
    ...
    if ( drv->i2sx == NULL )
    {
        ...
        drv->dma_init.DMA_M2M = DMA_M2M_Disable;
    ...
    interrupt_register_native(irq, (void*) drv, stm32f10x_i2sm_handler_native);
...
{
    if ( samplerate <= (8000 + 1512) )      drv->i2s_init.I2S_AudioFreq = I2S_AudioFreq_8k;
    else if (samplerate <= (11025 + 2487))  drv->i2s_init.I2S_AudioFreq = I2S_AudioFreq_11k;
    else if (samplerate <= (16000 + 3025 )) drv->i2s_init.I2S_AudioFreq = I2S_AudioFreq_16k;
    else if (samplerate <= (22050 + 4975 )) drv->i2s_init.I2S_AudioFreq = I2S_AudioFreq_22k;
    else if (samplerate <= (32000 + 6050 )) drv->i2s_init.I2S_AudioFreq = I2S_AudioFreq_32k;
    else if (samplerate <= (44100 + 1950 )) drv->i2s_init.I2S_AudioFreq = I2S_AudioFreq_44k;
    else if (samplerate <= (48000 + 24000)) drv->i2s_init.I2S_AudioFreq = I2S_AudioFreq_48k;
    else                                    drv->i2s_init.I2S_AudioFreq = I2S_AudioFreq_96k;
    I2S_Init( drv->i2sx, &drv->i2s_init );
    return drv->i2s_init.I2S_AudioFreq;
}
