...
#define TRICE_BUFFER_INFO do{ TRICE32( Id( 1701), "att: Trice 2x half buffer size:%4u ", TRICE_HALF_BUFFER_SIZE ); } while(0)
#else
...
#define TRICE_HEADLINE \
    TRICE0( Id( 6668), "s:                                          \n" ); \
    TRICE8( Id( 5952), "s:     NUCLEO-F411RE     TRICE_MODE %3u     \n", TRICE_MODE ); \
    TRICE0( Id( 4245), "s:                                          \n" ); \
    TRICE0( Id( 4604), "s:     " ); \
    TRICE_BUFFER_INFO; \
    TRICE0( Id( 7611), "s:     \n" ); \
