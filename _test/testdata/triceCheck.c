...
void TriceCheck(int n) {
    ...
    switch( n ){ 
        ...
        break; case __LINE__: TRICE8_B(ID(0), "  %02x", sABCDE, lenABCDE );                trice("\n" );  //exp: "time:feed3322default:   61  62  63  64  65  20  31  32  33  34  35\n"
        break; case __LINE__: TRICE8_B(ID(0), "BUF: %02x\n", sABCDE, lenABCDE );                          //exp: "time:feed3322default: BUF: 61 62 63 64 65 20 31 32 33 34 35\n"
        break; case __LINE__: TRICE8_B(ID(0), "%4d", sABCDE, lenABCDE );                   trice("\n" );  //exp: "time:feed3322default:   97  98  99 100 101  32  49  50  51  52  53\n"
        break; case __LINE__: TRICE8_B(ID(0), "  %02x", b8, sizeof(b8)/sizeof(int8_t) );   trice("\n" );  //exp: "time:feed3322default:   00  ff  fe  33  04  05  06  07  08  09  0a  0b  00  ff  fe  33  04  05  06  07  08  09  0a  0b\n"

        break; case __LINE__: TRice8B(" %02x", b8,  sizeof(b8) /sizeof(int8_t) );  trice("\n" ); //exp: "time:feed3322default:  00 ff fe 33 04 05 06 07 08 09 0a 0b 00 ff fe 33 04 05 06 07 08 09 0a 0b\n"
        break; case __LINE__: Trice8B(" %02x", b8,  sizeof(b8) /sizeof(int8_t) );  trice("\n" ); //exp: "time:    be16default:  00 ff fe 33 04 05 06 07 08 09 0a 0b 00 ff fe 33 04 05 06 07 08 09 0a 0b\n"
        break; case __LINE__: trice8B(" %02x", b8,  sizeof(b8) /sizeof(int8_t) );  trice("\n" ); //exp: "time:        default:  00 ff fe 33 04 05 06 07 08 09 0a 0b 00 ff fe 33 04 05 06 07 08 09 0a 0b\n"
        ...
        break; case __LINE__: trice8B("rd: %02x", b8,  sizeof(b8) /sizeof(int8_t) );      trice("\n" ); //exp: "time:        default: rd: 00 ff fe 33 04 05 06 07 08 09 0a 0b 00 ff fe 33 04 05 06 07 08 09 0a 0b\n"
        ...
        break; case __LINE__: TRICE16_B(ID(0), "  %04x", b16, sizeof(b16)/sizeof(int16_t) );  trice("\n" ); //exp: "time:feed3322default:   0000  ffff  fffe  3344\n"
        break; case __LINE__: TRice16B(" %04x", b16, sizeof(b16) /sizeof(int16_t) );          trice("\n" ); //exp: "time:feed3322default:  0000 ffff fffe 3344\n"
        break; case __LINE__: Trice16B(" %04x", b16, sizeof(b16) /sizeof(int16_t) );          trice("\n" ); //exp: "time:    be16default:  0000 ffff fffe 3344\n"
        break; case __LINE__: trice16B(" %04x", b16, sizeof(b16) /sizeof(int16_t) );          trice("\n" ); //exp: "time:        default:  0000 ffff fffe 3344\n"
        break; case __LINE__: trice16B("msg: %04x\n", b16, sizeof(b16) /sizeof(int16_t) );                  //exp: "time:        default: msg: 0000 ffff fffe 3344\n"

        break; case __LINE__: TRICE32_B(ID(0), " %08x", b32, sizeof(b32)/sizeof(int32_t) );   trice("\n" ); //exp: "time:feed3322default:  00000000 ffffffff fffffffe 33445555\n"
        break; case __LINE__: TRice32B(" %08x", b32, sizeof(b32) /sizeof(int32_t) );          trice("\n" ); //exp: "time:feed3322default:  00000000 ffffffff fffffffe 33445555\n"
        break; case __LINE__: Trice32B(" %08x", b32, sizeof(b32) /sizeof(int32_t) );          trice("\n" ); //exp: "time:    be16default:  00000000 ffffffff fffffffe 33445555\n"
...
";
    ...
    /**/break; case __LINE__: trice        ("value=%d\n", -2  ); //exp: "time:        default: value=-2\n"
        ...
        break; case __LINE__: TRice        ("no value" );  trice("\n" ); //exp: "time:feed3322default: no value\n"
        break; case __LINE__: Trice        ("no value" );  trice("\n" ); //exp: "time:    be16default: no value\n"
        break; case __LINE__: trice        ("no value" );  trice("\n" ); //exp: "time:        default: no value\n"
        break; case __LINE__: TRice8       ("no value" );  trice("\n" ); //exp: "time:feed3322default: no value\n"
        break; case __LINE__: Trice8       ("no value" );  trice("\n" ); //exp: "time:    be16default: no value\n"
        break; case __LINE__: trice8       ("no value" );  trice("\n" ); //exp: "time:        default: no value\n"
        break; case __LINE__: TRice16      ("no value" );  trice("\n" ); //exp: "time:feed3322default: no value\n"
        break; case __LINE__: Trice16      ("no value" );  trice("\n" ); //exp: "time:    be16default: no value\n"
        break; case __LINE__: trice16      ("no value" );  trice("\n" ); //exp: "time:        default: no value\n"
        break; case __LINE__: TRice32      ("no value" );  trice("\n" ); //exp: "time:feed3322default: no value\n"
        break; case __LINE__: Trice32      ("no value" );  trice("\n" ); //exp: "time:    be16default: no value\n"
        break; case __LINE__: trice32      ("no value" );  trice("\n" ); //exp: "time:        default: no value\n"
        break; case __LINE__: TRice64      ("no value" );  trice("\n" ); //exp: "time:feed3322default: no value\n"
        break; case __LINE__: Trice64      ("no value" );  trice("\n" ); //exp: "time:    be16default: no value\n"
        break; case __LINE__: trice64      ("no value" );  trice("\n" ); //exp: "time:        default: no value\n"
        break; case __LINE__: TRice_0      ("no value" );  trice("\n" ); //exp: "time:feed3322default: no value\n"
        break; case __LINE__: Trice_0      ("no value" );  trice("\n" ); //exp: "time:    be16default: no value\n"
        break; case __LINE__: trice_0      ("no value" );  trice("\n" ); //exp: "time:        default: no value\n"
        break; case __LINE__: TRice8_0     ("no value" );  trice("\n" ); //exp: "time:feed3322default: no value\n"
        break; case __LINE__: Trice8_0     ("no value" );  trice("\n" ); //exp: "time:    be16default: no value\n"
        break; case __LINE__: trice8_0     ("no value" );  trice("\n" ); //exp: "time:        default: no value\n"
        break; case __LINE__: TRice16_0    ("no value" );  trice("\n" ); //exp: "time:feed3322default: no value\n"
        break; case __LINE__: Trice16_0    ("no value" );  trice("\n" ); //exp: "time:    be16default: no value\n"
        break; case __LINE__: trice16_0    ("no value" );  trice("\n" ); //exp: "time:        default: no value\n"
        break; case __LINE__: TRice32_0    ("no value" );  trice("\n" ); //exp: "time:feed3322default: no value\n"
        break; case __LINE__: Trice32_0    ("no value" );  trice("\n" ); //exp: "time:    be16default: no value\n"
        break; case __LINE__: trice32_0    ("no value" );  trice("\n" ); //exp: "time:        default: no value\n"
        break; case __LINE__: TRice64_0    ("no value" );  trice("\n" ); //exp: "time:feed3322default: no value\n"
        break; case __LINE__: Trice64_0    ("no value" );  trice("\n" ); //exp: "time:    be16default: no value\n"
        break; case __LINE__: trice64_0    ("no value" );  trice("\n" ); //exp: "time:        default: no value\n"
        break; case __LINE__: TRice0       ("no value" );  trice("\n" ); //exp: "time:feed3322default: no value\n"
        break; case __LINE__: Trice0       ("no value" );  trice("\n" ); //exp: "time:    be16default: no value\n"
        break; case __LINE__: trice0       ("no value" );  trice("\n" ); //exp: "time:        default: no value\n"
        break; case __LINE__: TRice        ("no value" );  trice("\n" ); //exp: "time:feed3322default: no value\n"
        break; case __LINE__: Trice        ("no value" );  trice("\n" ); //exp: "time:    be16default: no value\n"
