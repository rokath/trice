...
#include "trice.h"
#include "trice_TargetActivity_c_KF1E016F27623CC56.h" // trice-bind: keep as last include before this file's Trice calls
...
void TriceCheckSpecial( int n ) {
        ...
        switch(n){
                ...
                // 'printi' is declared as -alias  in ./scripts/_120_setup_trice_environment.sh and defined here in triceConfig.h which is excluded from parsing in ./scripts/_120_setup_trice_environment.sh.
                // 'prints' is declared as -salias in ./scripts/_120_setup_trice_environment.sh and defined here in triceConfig.h which is excluded from parsing in ./scripts/_120_setup_trice_environment.sh.
